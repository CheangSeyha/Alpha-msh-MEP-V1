      ...
      <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 xl:px-0">
            ...
            >
              <div className="relative inline-block text-center">
                <h2 className="text-3xl md:text-4xl font-bold font-exo uppercase relative pb-2 z-10">
                  {t("lowvoltage")}
                </h2>
            ...
            <div className="relative w-full flex flex-col gap-10 md:gap-20 mt-10 md:mt-20 mb-10 z-50">
        ...
        <div className="relative">
          ...
          <div className="fixed inset-0 w-screen h-screen bg-cover bg-center">
            <img
              src="/Electrical/pexels-vladimirsrajber-19841119.jpg"
              alt="Our Approach"
        ...
        <div className="relative w-full bg-white z-50 mt-100">
          <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 xl:px-0">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="pb-1 flex justify-center pt-10"
            >
              <div className="relative inline-block text-center">
                <h2 className="text-3xl md:text-4xl font-bold font-exo uppercase relative pb-2 z-10">
                  {t("extralowvoltage")}
            ...
            <div className="relative w-full flex flex-col gap-10 md:gap-20 mt-10 mb-10">
