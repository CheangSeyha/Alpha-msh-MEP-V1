  ...
  return (
    <div className="flex flex-col">
      <div className="w-full flex flex-col justify-center items-center">
        <h1 className="text-center text-xl sm:text-2xl md:text-3xl font-light font-poppins text-black border-b-3 border-b-[#2D7FBD] uppercase w-fit mt-10">
          {t("lowvoltage")}
        </h1>
        ...
        <h1 className="text-center text-xl sm:text-2xl md:text-3xl font-light font-poppins text-black border-b-3 border-b-[#2D7FBD] uppercase w-fit mt-15">
          {t("extralowvoltage")}
        </h1>
