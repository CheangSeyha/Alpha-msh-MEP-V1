    ...
    >
      <div
        className={`w-full py-10 ${
          firstCard ? "border-t-4 border-[#2D7FBD]" : ""
        }`}
      >
        <div className="mx-auto max-w-md overflow-hidden rounded-xl bg-white shadow-md md:max-w-6xl border">
          <div className="md:flex transition-all duration-500 ease-in-out">
            ...
            <div className="px-8 max-[530px]:px- py-4">
              <div className="text-base max-[900px]:text-sm font-poppins font-semibold tracking-wide text-indigo-500 uppercase transition-all duration-500 ease-in-out">
                {t("informations")}
              </div>
