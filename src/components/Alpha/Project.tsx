        ...
        <div className="max-w-full flex flex-wrap gap-6">
          ...
          <div className="relative md:w-[500px] bg-cover bg-center font-exo overflow-hidden">
            <img
              src="/completed.jpg"
              alt="Project"
              className="w-full object-cover rounded-lg shadow-md hover:scale-110 transition-transform duration-500 ease-in-out"
            />
          ...
          <div className="relative md:w-[500px] bg-cover bg-center font-exo">
            ...
            />
            <div className="absolute bottom-0 right-1/2 transform translate-x-1/2 mb-4">
